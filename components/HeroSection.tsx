      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center gap-12 max-w-7xl">
        <div className="w-full lg:w-3/5 text-center lg:text-left">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#012269] leading-tight mb-6">
            ...
            <span className="text-[#E40229]">Complete 2026 Guide</span>
          </h1>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
            Planning to gain professional skills in Australia? The Australia
            Training Visa (Subclass 407) allows international professionals to
            undertake structured workplace training with an approved Australian
            sponsor. Whether you need licensing hours or want to enhance your
            skills, the 407 visa opens doors to world-class training
        ...
        <div className="w-full lg:w-2/5">
          <div className="bg-white/60 backdrop-blur-xl border border-gray-100 p-8 rounded-3xl shadow-2xl relative">
            <h3 className="text-2xl font-bold text-[#012269] mb-6">
              Key Benefits
            </h3>
            <ul className="space-y-5">
              {stats.map((stat, i) => (
                <li key={i} className="flex items-start gap-4">
                  ...
                  <span className="text-gray-700 font-medium text-lg leading-tight">
                    {stat}
                  </span>
                </li>
              ))}
